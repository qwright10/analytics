...
export default class ReloadCommand extends Command {
    ...
    public async exec(
        ...
        const mod =
            commandHandler.modules.get(module) ??
            inhibitorHandler.modules.get(module) ??
            listenerHandler.modules.get(module);
        if (!mod)
